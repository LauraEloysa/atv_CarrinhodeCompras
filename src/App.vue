  ...
  [
    {
      ...
      preco: 47.92,
      capa: 'public/image/OPrincipeCruel.jpg',
      autor: 'Holly Black',
    },
    {
      id: 2,
...
const lsitaCarrinho = ref([]);

function adicionarCarrinho(livro){
    listaCarrinho.value.push(livro);
}
  ...
  <main>
    <header>
      <div>
        ...
        <ul class="Icones">
          ...
          <li>
            <FontAwesomeIcon icon="heart"  @click="valorBooleano = !valorBooleano"/>
          </li>
          <li>
    ...
    <body v-if="valorBooleano">
      ...
      <section class="random"  style="display: flex; align-items: center;">
        ...
        <div>
          <img :src="livroEscolhido.capa" alt="#" style="flex: 1 1 400px; width: 320px; height:450px; box-shadow: 3px 3px 5px #4F4C57; margin-left: 15vw;">
      ...
      <section class="livros">
        ...
        <ul style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: center;">
          ...
          <li v-for="livro in listaLivros" :key="livro.id" style="width: 19%; justify-items: left;">
            ...
            <button>
              <FontAwesomeIcon icon="cart-shopping" /> Comprar
            </button>
          </li>
        </ul>
